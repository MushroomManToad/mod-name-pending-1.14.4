...
public class VimionicAbominationModel extends EntityModel<VimionicAbominationEntity> {
	...
	public VimionicAbominationModel() {
		...
		rightarm.cubeList.add(new ModelBox(rightarm, 204, 0, -8.0F, -38.0F, -2.0F, 4, 12, 4, 0.0F, false));
		...
		core.addChild(head);
		head.cubeList.add(new ModelBox(head, 224, 18, -4.0F, -46.0F, -4.0F, 8, 8, 8, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 220, 0, -4.5F, -46.5F, -4.5F, 9, 9, 9, 0.0F, false));

		leftarm = new RendererModel(this);
		leftarm.setRotationPoint(0.0F, 0.0F, 0.0F);
		core.addChild(leftarm);
		leftarm.cubeList.add(new ModelBox(leftarm, 204, 16, 4.0F, -38.0F, -2.0F, 4, 12, 4, 0.0F, true));

		leftleg = new RendererModel(this);
		leftleg.setRotationPoint(0.0F, 0.0F, 0.0F);
		core.addChild(leftleg);
		leftleg.cubeList.add(new ModelBox(leftleg, 204, 32, 0.0F, -26.0F, -2.0F, 4, 12, 4, 0.0F, true));

		rightleg = new RendererModel(this);
		rightleg.setRotationPoint(0.0F, 0.0F, 0.0F);
		core.addChild(rightleg);
		rightleg.cubeList.add(new ModelBox(rightleg, 188, 32, -4.0F, -26.0F, -2.0F, 4, 12, 4, 0.0F, false));
	...
	public void setCustomRotations(VimionicAbominationEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor)
	{
		this.tendril1.rotateAngleY = (ageInTicks) / 15;
		this.tendril2.rotateAngleY = (float) (((ageInTicks) / 15) + Math.PI);
	}
}