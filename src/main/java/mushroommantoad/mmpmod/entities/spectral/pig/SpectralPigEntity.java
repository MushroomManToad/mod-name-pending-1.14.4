...
public class SpectralPigEntity extends CreatureEntity implements ISpectralEntity
{
	private static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(Items.CARROT, Items.POTATO, Items.BEETROOT);
	
	@SuppressWarnings("unchecked")
	public SpectralPigEntity(EntityType<? extends CreatureEntity> type, World worldIn) 
	{
		super((EntityType<? extends CreatureEntity>) ModEntities.SPECTRAL_PIG, worldIn);
	}
	...
	{
		return ModSoundEvents.spectral_pig_say;
	}
	
	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn) 
	{
		return ModSoundEvents.spectral_pig_hurt;
	}

	@Override
	protected SoundEvent getDeathSound() 
	{
		return ModSoundEvents.spectral_pig_death;
	}
	...
	protected boolean processInteract(PlayerEntity player, Hand hand) 
	{
		...
		if(stack.getItem() == Items.CARROT || stack.getItem() == Items.POTATO || stack.getItem() == Items.BEETROOT)
		{
